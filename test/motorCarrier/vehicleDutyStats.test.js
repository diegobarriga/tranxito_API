...
describe('GET MotorCarriers/:id/vehiclesDutyStats', function() {
  it('Should get duty status of vehicles from the motor carrier' +
    ' specified', function(done) {
    authenticatedSupport.get('/api/MotorCarriers/' +
      currentSupport.motorCarrierId + '/vehiclesDutyStats/?access_token=' +
  ...
  it('Should not get duty status of vehicles from the motor carrier' +
  ...
  it('Should not get duty status of vehicles from the motor carrier specified' +
    ' if accessToken is invalid', function(done) {
    authenticatedSupport.get('/api/MotorCarriers/' +
      currentSupport.motorCarrierId + '/vehiclesDutyStats/?access_token=' +
      '1314kfs4j1')
    .set('Accept', 'application/json')
