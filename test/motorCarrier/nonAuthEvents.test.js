...
describe('GET MotorCarriers/:id/nonAuthEvents', function() {
  it('Should get unauthentified events from the motor carrier' +
    ' specified', function(done) {
    authenticatedSupport.get('/api/MotorCarriers/' +
      currentSupport.motorCarrierId + '/nonAuthEvents/?access_token=' +
  ...
  it('Should not get unauthentified events from the motor carrier specified' +
