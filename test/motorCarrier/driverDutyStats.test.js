...
describe('GET MotorCarriers/:id/driversDutyStats', function() {
  it('Should get duty status of drivers from the motor carrier' +
    ' specified', function(done) {
    authenticatedSupport.get('/api/MotorCarriers/' +
      currentSupport.motorCarrierId + '/driversDutyStats/?access_token=' +
  ...
  it('Should not get duty status of drivers from the motor carrier' +
  ...
  it('Should not get duty status of drivers from the motor carrier specified' +
